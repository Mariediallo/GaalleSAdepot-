...
if ( ! defined( 'BLOSSOM_FASHION_THEME_VERSION' ) && ! defined( 'BLOSSOM_FASHION_THEME_NAME' ) && ! defined( 'BLOSSOM_FASHION_THEME_TEXTDOMAIN' ) ) {
	$theme_data = wp_get_theme();	
	define ( 'BLOSSOM_FASHION_THEME_VERSION', $theme_data->get( 'Version' ) );
	define ( 'BLOSSOM_FASHION_THEME_NAME', $theme_data->get( 'Name' ) );
	define ( 'BLOSSOM_FASHION_THEME_TEXTDOMAIN', $theme_data->get( 'TextDomain' ) );
}
